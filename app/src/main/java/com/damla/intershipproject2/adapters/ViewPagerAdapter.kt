...
class ViewPagerAdapter(private val nowPlayingMovieList : List<Result>) :
    ...
    inner class ViewHolder(private val binding : ItemNowPlayingBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val dataHolder = ItemNowPlayingBinding.inflate(LayoutInflater.from(parent.context),parent,false)
